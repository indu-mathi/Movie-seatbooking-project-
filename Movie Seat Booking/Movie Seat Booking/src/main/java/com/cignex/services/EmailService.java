	...
	public void sendmail(String name, String email, String random) throws AddressException, MessagingException {
		...
		Authenticator auth = new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("Roomlooindia@gmail.com", "Roomlooindia1608");
			}
		};
		...
		try {
			...
			msg.setFrom(new InternetAddress("Roomlooindia@gmail.com", "NoReply-Pinal"));

			msg.setReplyTo(InternetAddress.parse("Roomlooindia@gmail.com", false));
